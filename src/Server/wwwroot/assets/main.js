...
`].filter(fs).join(`
`)),o=da(o),o=$c(o,t),o=Yc(o,t),a=da(a),a=$c(a,t),a=Yc(a,t),o=qc(o),a=qc(a),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+f);const M=E+p+o,v=E+f+a,D=Gc(i,i.VERTEX_SHADER,M),A=Gc(i,i.FRAGMENT_SHADER,v);i.attachShader(_,D),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(P){if(s.debug.checkShaderErrors){const H=i.getProgramInfoLog(_).trim(),k=i.getShaderInfoLog(D).trim(),$=i.getShaderInfoLog(A).trim();let J=!0,Y=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(J=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,D,A);else{const ee=Xc(i,D,"vertex"),W=Xc(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
